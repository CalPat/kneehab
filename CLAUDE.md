...
**Luc van Loon (Maastricht)** — muscle protein synthesis: dose, distribution, and timing. ~0.4 g/kg per feeding spread across the day, and **30–40 g casein before bed** — the muscle-side counterpart to the nocturnal GH pulse Baar names as the second synthesis window. **⚠ THIS SPECIFIC APPLICATION IS RULED OUT IN THIS PROGRAM (v15.01, 2026-08-27).** It collided head-on with the live *“no food 90 min before sleep”* rule, and **the sleep rule won**. The deciding argument is Phillips, below, as the evidence filter: protein already runs **150–175 g/day across ~4 feedings**, at or above the ceiling of useful intake, and van Loon’s pre-sleep protocol pays off mainly when daily protein is inadequate or badly distributed — neither is true here. **van Loon still owns the timing principle** (dose per feeding, distribution across the day); only the pre-sleep feeding is off. *Do not re-propose it — the ruling stands. If overnight coverage is the worry, move the 4th feeding later inside the window, never add a 5th after it.* Owns the protein window that Baar's collagen protocol is defined *against*.
